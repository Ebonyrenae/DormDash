...
function Settings() {
  ...
  const fetchUserSettings = async (currentUserId: number | null): Promise<void> => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/get_user_settings.php?userId=${currentUserId}`, {
        credentials: 'include'
      });
    ...
    {/* Main Content */}
      <main style={{ flex: 1, marginLeft: 0 }}>
        ...
        <div style={{ maxWidth: '896px', margin: '0 auto', padding: '32px 16px', display: 'flex', flexDirection: 'column', gap: '32px' }}>
          ...
          {/* Account Settings */}
          <div>
            <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#111827', marginBottom: '16px', paddingLeft: '4px' }}>Account Settings</h3>
            <div style={{
              backgroundColor: 'white',
              borderRadius: '16px',
              boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1)',
          ...
          {/* Preferences */}
          <div>
            <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#111827', marginBottom: '16px', paddingLeft: '4px' }}>Preferences</h3>
            <div style={{
              backgroundColor: 'white',
              borderRadius: '16px',
              boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1)',
  ...
  return (
    <button
      ...
      style={{
        ...
        transition: 'all 0.2s',
        marginBottom: '4px',
        backgroundColor: active ? '#D1FAE5' : (isHovered ? '#F3F4F6' : 'transparent'),
...
function SettingItem({ icon: Icon, label, value, onClick, color }: SettingItemProps) {
  const [isHovered, setIsHovered] = useState(false);
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1 }}>
        <h4 style={{ fontWeight: '500', color: '#111827', margin: '0 0 2px 0', fontSize: '15px' }}>{label}</h4>
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#F9FAFB' }}>
      <div style={{ maxWidth: '768px', margin: '0 auto', padding: '32px 16px' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', paddingBottom: '16px', borderBottom: '1px solid #F3F4F6', marginBottom: '24px' }}>
            <div style={{
              width: '48px',
              height: '48px',
              borderRadius: '12px',
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#F9FAFB' }}>
      <div style={{ maxWidth: '768px', margin: '0 auto', padding: '32px 16px' }}>
        <div style={{ marginBottom: '24px' }}>
          ...
          <h1 style={{ fontSize: '30px', fontWeight: '700', color: '#111827', margin: '0 0 8px 0' }}>Change Password</h1>
          <p style={{ color: '#6B7280', marginTop: '8px', fontSize: '16px' }}>Update your account password for enhanced security</p>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', paddingBottom: '16px', borderBottom: '1px solid #F3F4F6', marginBottom: '24px' }}>
            ...
            <div>
              <h3 style={{ fontWeight: '600', color: '#111827', margin: 0, fontSize: '16px' }}>Security Update</h3>
              <p style={{ fontSize: '14px', color: '#6B7280', margin: 0 }}>Choose a strong, unique password</p>
            </div>
          </div>
          ...
          <div style={{
            ...
            <p style={{ fontSize: '14px', fontWeight: '500', color: '#1E3A8A', margin: '0 0 8px 0' }}>
              Password Requirements:
            </p>
        ...
        <div style={{
          ...
          <h4 style={{ fontWeight: '600', color: '#111827', marginBottom: '12px', fontSize: '16px', display: 'flex', alignItems: 'center', gap: '8px' }}>
            <ShieldIcon />
            Security Tips
          </h4>
          <ul style={{ fontSize: '14px', color: '#6B7280', margin: 0, paddingLeft: '20px', lineHeight: '1.6' }}>
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#F9FAFB' }}>
      <div style={{ maxWidth: '768px', margin: '0 auto', padding: '32px 16px' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', maxHeight: '384px', overflowY: 'auto' }}>
            {filteredUniversities.map((uni) => (
              <button
                ...
                style={{
                  ...
                  border: uni === university ? '2px solid #16A34A' : '2px solid transparent',
                  cursor: 'pointer',
                  fontSize: '16px',
                  textAlign: 'left'
                }}
            ...
            {filteredUniversities.length === 0 && (
              <div style={{ textAlign: 'center', padding: '32px', color: '#6B7280' }}>No universities found</div>
            )}
          </div>
        </div>
      ...
      <div style={{ maxWidth: '768px', margin: '0 auto', padding: '32px 16px' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <div style={{
            ...
            <div style={{ borderBottom: '1px solid #F3F4F6' }}></div>
            <ToggleItem icon={SmartphoneIcon} label="Push Notifications" description="Get instant alerts on your device" checked={settings.push} onChange={() => toggleSetting('push')} color="purple" />
            <div style={{ borderBottom: '1px solid #F3F4F6' }}></div>
            <ToggleItem icon={MessageSquareIcon} label="SMS Notifications" description="Receive text messages" checked={settings.sms} onChange={() => toggleSetting('sms')} color="green" />
          </div>
        </div>
...
function PrivacyPage({ settings, updateSettings, goBack, setCurrentPage }: PrivacyPageProps) {
      ...
      <div style={{ maxWidth: '768px', margin: '0 auto', padding: '32px 16px' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <div style={{
            ...
            <div style={{ borderBottom: '1px solid #F3F4F6' }}></div>
            <ToggleItem icon={EyeIcon} label="Show Email Address" description="Display email on your public profile" checked={settings.showEmail} onChange={() => toggleSetting('showEmail')} color="purple" />
            <div style={{ borderBottom: '1px solid #F3F4F6' }}></div>
            <ToggleItem icon={EyeOffIcon} label="Show Phone Number" description="Display phone on your public profile" checked={settings.showPhone} onChange={() => toggleSetting('showPhone')} color="orange" />
          </div>
        </div>
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <div style={{
            ...
            <SecurityActionButton
              ...
              color="blue"
              onClick={() => alert('Opening two-factor authentication setup...')}
            />
          </div>
        </div>
...
function SecurityActionButton({ icon: Icon, label, description, color, onClick }: SecurityActionButtonProps) {
  const [isHovered, setIsHovered] = useState(false);
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1 }}>
        <h4 style={{ fontWeight: '500', color: '#111827', margin: 0, fontSize: '15px' }}>{label}</h4>
        <p style={{ fontSize: '14px', color: '#6B7280', margin: '2px 0 0 0' }}>{description}</p>
      </div>
      <div style={{
        color: isHovered ? '#16A34A' : '#9CA3AF',
        transition: 'all 0.2s'
...
function HelpCenterPage({ goBack }: HelpCenterPageProps) {
  ...
  const faqs = [
    { question: 'How do I reset my password?', answer: 'Go to Privacy & Security settings and click "Change Password". You\'ll receive a verification email to complete the process.' },
    { question: 'How do I change my notification preferences?', answer: 'Navigate to Settings > Preferences > Notifications to customize which notifications you receive.' },
    { question: 'Can I change my university affiliation?', answer: 'Yes! Go to Account Settings > University and select your institution from the list.' },
    { question: 'How do I contact support?', answer: 'Email us at support@university.edu or call (555) 123-4567 during business hours (9 AM - 5 PM EST).' },
    { question: 'Is my data secure?', answer: 'Yes! We use industry-standard encryption and security measures to protect your information.' },
  ];
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#F9FAFB' }}>
      <div style={{ maxWidth: '896px', margin: '0 auto', padding: '32px 16px' }}>
        <div style={{ marginBottom: '24px' }}>
          ...
          <h1 style={{ fontSize: '30px', fontWeight: '700', color: '#111827', margin: '0 0 8px 0' }}>Help Center</h1>
          <p style={{ color: '#6B7280', marginTop: '8px', fontSize: '16px' }}>Find answers to common questions and get support</p>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <p style={{ color: '#D1FAE5', marginBottom: '16px' }}>Our support team is here to assist you with any questions or concerns.</p>
              <button
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div>
                <p style={{ fontSize: '14px', color: '#D1FAE5', margin: 0 }}>Email</p>
                <p style={{ fontWeight: '500', margin: 0 }}>support@university.edu</p>
              </div>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ color: '#D1FAE5' }}>
              ...
              <div>
                <p style={{ fontSize: '14px', color: '#D1FAE5', margin: 0 }}>Phone</p>
                <p style={{ fontWeight: '500', margin: 0 }}>(555) 123-4567</p>
              </div>
            </div>
          </div>

          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '16px', fontSize: '14px', color: '#D1FAE5' }}>
            <ClockIcon />
        ...
        <div>
          <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#111827', marginBottom: '16px', paddingLeft: '4px' }}>Frequently Asked Questions</h3>
          <div style={{
            backgroundColor: 'white',
            borderRadius: '16px',
            boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1)',
                ...
                <div key={index}>
                  <button
                    ...
                    style={{
                      ...
                      transition: 'background-color 0.2s',
                      border: 'none',
                      borderBottom: index === faqs.length - 1 && !isExpanded ? 'none' : '1px solid #F3F4F6',
                      cursor: 'pointer',
                      textAlign: 'left'
                    }}
                  ...
                  >
                    <div style={{ flex: 1 }}>
                      <h4 style={{ fontWeight: '500', color: '#111827', marginBottom: '4px', fontSize: '15px' }}>{faq.question}</h4>
                      {isExpanded && (
                        <p style={{
                          fontSize: '14px',
                          color: '#6B7280',
...
function ToggleItem({ icon: Icon, label, description, checked, onChange, color }: ToggleItemProps) {
  const colorClasses = {
    blue: { bg: '#DBEAFE', text: '#1D4ED8' },
    purple: { bg: '#E9D5FF', text: '#7C3AED' },
      ...
      <div style={{ maxWidth: '480px', width: '100%' }}>
        <div style={{
          ...
          <p style={{
            ...
            Are you sure you want to log out of your account? You'll need to sign in again to access your settings.
          </p>
          ...
          <div style={{
            ...
            <p style={{
              ...
              <strong>Note:</strong> Your settings and data will be saved. You can sign back in anytime.
            </p>
          </div>
        </div>
      </div>
